...
//        {name:'Heading 6', key:'6', openWith:'\nh6(!(([![Class]!])!)). ', className: 'markitup-h6' }, 
		...
		{separator:'---------------' },
        {name:"Image", callBack:"openImageWindow", className: 'markitup-pivotximg' },
        {name:"Popup", callBack:"openImagePopupWindow", className: 'markitup-pivotxpopup' },
        {name:"Download", callBack:"openDownloadWindow", className: 'markitup-pivotxdownload' },
        {name:"Tag", callBack:"openTagWindow", className: 'markitup-pivotxtag' },
		{name:'pivotx', dropMenu: pivotxtemplates, className: 'markitup-pivotxtemplates' },	           
        {separator:'---------------' },
