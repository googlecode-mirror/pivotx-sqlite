...
function safeAddress($emailAddress, $theText, $theTitle, $xhtml, $isItSafe) {
    ...
    $noscript_text = __('Please enable Javascript (and reload this page) to view the e-mail address.');
    
    $endResult = "
<span id='safe_address_noscript_$count' title='$noscript_text'>$theText</span>
$prefix
<!--
    var first = 'ma';
    var second = 'il';
    ...
    var el = document.getElementById('safe_address_noscript_$count');
