...
//
// $Id: module_imagefunctions.php 2163 2009-10-11 17:05:54Z hansfn $
//
// ---------------------------------------------------------------------------
...
$PIVOTX['image'] = array();
$PIVOTX['image']['mw'] = get_default($PIVOTX['config']->get('upload_thumb_width'), 200);
$PIVOTX['image']['mh'] = get_default($PIVOTX['config']->get('upload_thumb_height'), 200);
$PIVOTX['image']['qual'] = get_default($PIVOTX['config']->get('upload_thumb_quality'), 70);
...
function gd_crop($thumb) {
    ...
    if( !in_array($img->ext, array('gif', 'jpg', 'png'))) {
    ...
    if($PIVOTX['image']['local']) {
        ...
        $remoteurl = get_default($PIVOTX['config']->get('remote_crop_script'), 
