...
// - Updatecheck: http://www.pivotx.net/update.php?ext=sociable
// - Description: A snippet extension to show links to various social bookmark sites.
// - Date: 2008-02-24
// - Identifier: sociable

/**
 * This extension adds links to various social bookmarking sites.
 *
 * It is based loosely on the Sociable extension for Wordpress, by
 * Peter Harkins, Joost de valk: http://www.joostdevalk.nl/wordpress/sociable/
 *
 * Don't forget to add the [[sociable]] tag to your template, where you'd like to have it.
 *
 */
...
function smarty_sociable($params, &$smarty) {
    ...
    $tagline = get_default($PIVOTX['config']->get('sociable_tagline'), $sociable_config['sociable_tagline']);  
    $blank = get_default($PIVOTX['config']->get('sociable_blank'), $sociable_config['sociable_blank']);  
