 ...
 *
 */
$twittername = get_default($PIVOTX['config']->get('lifestream_twitterusername'), $lifestream_config['lifestream_twitterusername']);
$twitterpass = get_default($PIVOTX['config']->get('lifestream_twitterpassword'), $lifestream_config['lifestream_twitterpassword']);
$summize = get_default($PIVOTX['config']->get('lifestream_summize'), $lifestream_config['lifestream_summize']);
$tumblrname = get_default($PIVOTX['config']->get('lifestream_tumblrusername'), $lifestream_config['lifestream_tumblrusername']);
$flickrfeed = get_default($PIVOTX['config']->get('lifestream_flickrfeed'), $lifestream_config['lifestream_flickrfeed']);
$lastfmname = get_default($PIVOTX['config']->get('lifestream_lastfmusername'), $lifestream_config['lifestream_lastfmusername']);
$max = get_default($PIVOTX['config']->get('lifestream_max_items'), $lifestream_config['lifestream_max_items']);
$maxperfeed = get_default($PIVOTX['config']->get('lifestream_max_perfeed'), $lifestream_config['lifestream_max_perfeed']);
$header = get_default($PIVOTX['config']->get('lifestream_header'), $lifestream_config['lifestream_header']);
$format = get_default($PIVOTX['config']->get('lifestream_format'), $lifestream_config['lifestream_format']);
$footer = get_default($PIVOTX['config']->get('lifestream_footer'), $lifestream_config['lifestream_footer']);

if ( empty($twittername) && empty($summize) && empty($tumblrname) ) {
...
foreach($items2 as $item) {
    ...
    $temp_output = str_replace('%date%', format_date($item['date_timestamp'], "%fuzzy%"), $temp_output );
