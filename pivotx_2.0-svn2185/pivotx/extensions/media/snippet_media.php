...
// - Updatecheck: http://www.pivotx.net/update.php?ext=media
...
function smarty_media_audio($params, &$smarty) {
    ...
    $values['description'] = get_default($params['description'], __("Playing \"%nicefilename%\".") );
...
function smarty_media_youtube($params, &$smarty) {
    ...
    $values['description'] = get_default($params['description'], __("Youtube video \"%basename%\".") );
    $values['width'] = get_default($params['width'], 425 );
    $values['height'] = get_default($params['height'], 355 );
    $values['useinfobox'] = $params['useinfobox'];
...
function smarty_media_vimeo($params, &$smarty) {
    ...
    $values['description'] = get_default($params['description'], __("Vimeo video \"%basename%\".") );
    $values['width'] = get_default($params['width'], 400 );
    $values['height'] = get_default($params['height'], 300 );
    $values['useinfobox'] = $params['useinfobox'];
...
function smarty_media_video($params, &$smarty) {
    ...
    $values['description'] = get_default($params['description'], __("Video \"%nicefilename%\"") );
    $values['image'] = get_default($params['image'], $mediaplayerpath."screen.jpg");
    $values['width'] = get_default($params['width'], 400 );
    $values['height'] = get_default($params['height'], 300 );
    $values['useinfobox'] = $params['useinfobox'];
