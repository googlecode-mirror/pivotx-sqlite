<?php
/**
 * Contains the functions needed to use Pivot in different languages (locales)
...
//
// $Id: module_i18n.php 2096 2009-09-03 08:40:52Z hansfn $
//
// ---------------------------------------------------------------------------
...
function  i18n_entify($i) {
    global $PIVOTX;
    switch ($PIVOTX['languages']->getCode()) {
        case 'ja':
            break;
        default:
