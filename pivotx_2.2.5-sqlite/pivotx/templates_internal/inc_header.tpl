...
<head>
    ...
    <script src="includes/js/jquery-ui-1.8.9.custom.min.js" type="text/javascript"></script>
    ...
    <link rel="stylesheet" href="templates_internal/ui-theme/jquery-ui-1.8.9.custom.css" type="text/css" />
...
<div id="header">
    ...
    <div id="sitenamediv">
        <a href="[[ $paths.site_url ]]" class="front_end">[[ $config.sitename ]]</a>
    </div>
