...
//
// $Id: module_upload.php 3490 2011-02-07 13:13:00Z marcelfw $
//
// ---------------------------------------------------------------------------
...
class UploadElement {
    ...
    public function render($params) {
        ...
        $os->addCode('jquery_ui',           OutputSystem::LOC_HEADEND,'script',array('_priority'=>OutputSystem::PRI_HIGH,'
            src'=>$pivotx_url . 'includes/js/jquery-ui-1.8.9.custom.min.js'));
        $os->addCode('plupload_gears',      OutputSystem::LOC_HEADEND,'script',array('src'=>$pivotx_url . 'includes/js/plupload/gears_init.js'));
        ...
        $os->addCode('plupload_full',       OutputSystem::LOC_HEADEND,'script',array('src'=>$pivotx_url . 'includes/js/plupload/plupload.full.min.js'));
