...
[[ if $moderating ]]
    ...
    <h3>[[t]]Comments waiting for moderation[[/t]].</h3>
        ...
        <table class='formclass tabular' cellspacing='0' border='0' width='800'>
            ...
            <tr class="moderate [[ if $comment.blocked ]]blocked[[/if]]">
            ...
            <td rowspan='2' class="buttons_small nowrap" style='border-bottom: 1px solid #BBB; color: #777;'>
                [[ if $comment.allowedit]]
                <a href="index.php?page=editcomment&amp;uid=[[ $comment.entry_uid ]]&amp;key=[[ $comment.uid ]]&return=overview" class="dialog comment" title="[[t]]Edit this comment[[/t]]">
