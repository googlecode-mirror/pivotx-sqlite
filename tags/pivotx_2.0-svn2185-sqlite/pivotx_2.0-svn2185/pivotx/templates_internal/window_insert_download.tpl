...
window.onload = function() {
    var settings = {
        ...
        file_types : "*.doc;*.docx;*.pdf;*.txt;*.rtf;*.ppt;*.mp3;*.zip;*.dmg;*.xls;*.sps;*.sql",
        ...
        // Button settings
        button_image_url: "[[/literal]][[$paths.pivotx_url]][[literal]]includes/uploader/button_file.png",	// Relative to the Flash file
        button_width: "199",
        button_height: "32",
