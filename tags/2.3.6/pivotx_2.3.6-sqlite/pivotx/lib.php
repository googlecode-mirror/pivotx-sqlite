...
//
// $Id: lib.php 4227 2012-11-16 12:31:52Z pivotlog $
//
// ---------------------------------------------------------------------------
...
if (!empty($codename)) {
    $build = sprintf("PivotX-SQLite - %s: <span>%s</span>", $version, $codename);    
} else {
    $build = sprintf("PivotX-SQLite - %s", $version);
}
