...
//
// $Id: module_image.php 2163 2009-10-11 17:05:54Z hansfn $
//
// ---------------------------------------------------------------------------
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function cropFixed() {
            ...
            jQuery('#cropbox').Jcrop({
                ...
                setSelect: [ defX+5, defY+5, (defX+maxWidth-5), (defY+maxHeight-5) ]
            });
...
function get_image_attributes(&$img) {
    ...
    if (file_exists($img)) {
        ...
        echo "<br />'$img' " . __("can not be opened") . ". <br />";
        echo __("Current path") . ": " . getcwd() . "<br />";
        die();
    }
...
class Attributes extends Image {
    ...
    function Attributes($n,$w,$h,$x,$y, $link)
    {
        ...
        if ($this->ext != '') {
            $this->new_name = make_thumbname($_GET['image']);
...
function print_crop_editor() {
    ...
    $factor = max( ($img->w / 580) , ($img->h / 500) );
...
?>
    ...
    <div id="testWrap" style="float:left;">
        ...
        <img src="<?php echo $filelink; ?>" alt="Cropping image" id="cropbox" width="<?php echo $w; ?>" height="<?php echo $h; ?>" />
    </div>
