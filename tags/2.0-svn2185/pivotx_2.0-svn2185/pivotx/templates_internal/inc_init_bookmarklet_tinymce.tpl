...
tinyMCE_GZ.init({
	plugins : "safari,paste,fullscreen", // add contextmenu if you don't want Firefox's spellchecker
	themes : 'advanced',
	languages : 'en',
...
function initTinyMCE() {
	...
	tinyMCE.init({
		...
		extended_valid_elements : "a[href|target|name|title|rel|class|id],hr[class|width|size|noshade],font[face|size|color|style|class]," +
				"span[class|align|style],img[class|src|border=0|alt|title|hspace|vspace|width|height|align|onmouseover|onmouseout|name],"+
		...
		plugins : "safari,searchreplace,paste,fullscreen", // add contextmenu if you don't want Firefox's spellchecker
		convert_urls : false,
		media_strict : false
