...
//
// $Id: entries_sql.php 3277 2010-11-23 19:38:33Z pivotlog $
//
// ---------------------------------------------------------------------------
...
//[/JAN]
    ...
    function getArchiveArray($force=FALSE, $unit) {
        ...
        foreach($weblognames as $weblogname) {
            ...
            $categories = array_map('safeString', $categories);
   ...
   /**
    ...
    function read_entries($params) {
        ...
        if(!empty($params['uid'])) {
            ...
            // without the bug.
//[JAN]
// Ordering into group by clause is not allowed by SQL standard...
...
//[JAN]
// Avevo aggiunto anche questo... ma forse ora è superfluo
