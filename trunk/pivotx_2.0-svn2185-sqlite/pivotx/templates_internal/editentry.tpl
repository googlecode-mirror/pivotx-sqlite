        ...
        <div class="leftcolumn">
            ...
            <table border="0" cellspacing="0" class="formclass" width="650">
                ...
                <tr>
                    ...
                    <td><input name="subtitle" type="text" value="[[ $entry.subtitle|escape ]]" class="xl" /></td>
                </tr>
            </table>
            ...
            <textarea name="introduction" id="introduction" class="Editor" rows='50'
                cols='4'>[[ if $user.text_processing==5 ]][[ $entry.introduction|escape:html ]][[ else ]][[ $entry.introduction ]][[/if]]</textarea>
    
            [[ hook name="entry-body-before" value=$entry ]]

            <p><strong>[[t]]Body[[/t]]:</strong></p>
            <textarea name="body" id="body" class="Editor" rows='50'
                cols='4'>[[ if $user.text_processing==5 ]][[ $entry.body|escape:html ]][[ else ]][[ $entry.body ]][[/if]]</textarea>
            ...
            <table border="0" cellpadding="0" class="formclass">
                ...
                <tr>
                    <td colspan="2"><p><strong>[[t]]Publish on[[/t]]:</strong></p>
                        ...
                        value="[[ date date=$entry.publish_date format='%month%-%day%-%year%' ]]" size="15" />
                ...
                <tr>
                    <td colspan="2">
                        ...
                        value="[[ date date=$entry.date format='%month%-%day%-%year%' ]]" size="15" />
                ...
                <tr>
                    <td colspan="2"><p><strong>[[t]]Last edited on[[/t]]:</strong></p>
                        ...
                        value="[[ date date=$entry.edit_date format='%month%-%day%-%year%' ]]" size="15" />
                ...
                <tr>
                    ...
                    <td><input name="code" type="hidden" value="[[ $entry.code ]]" />[[ $entry.code ]]</td>
                </tr>
            </table>
