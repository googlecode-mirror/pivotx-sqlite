...
$max = get_default($PIVOTX['config']->get('delicious_max_items'), $delicious_config['delicious_max_items']);
$header = get_default($PIVOTX['config']->get('delicious_header'), $delicious_config['delicious_header']);
$format = get_default($PIVOTX['config']->get('delicious_format'), $delicious_config['delicious_format']);
$footer = get_default($PIVOTX['config']->get('delicious_footer'), $delicious_config['delicious_footer']);
