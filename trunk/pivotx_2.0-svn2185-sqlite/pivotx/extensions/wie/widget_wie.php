...
// - Updatecheck: http://www.pivotx.net/update.php?ext=wie
...
function wieAdmin(&$form_html) {
    ...
    $form->add( array(
        'type' => 'text',
        'name' => 'wie_userid',
        'label' => "Your WIE login name",
        'value' => '',
        'error' => 'That\'s not a proper login name!',
        'text' => "The name you use to log in at <a href='http://www.wieonline.nl/'>wieonline.nl</a>",
        'size' => 32,
        'isrequired' => 1,
